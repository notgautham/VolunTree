...
/* Page layout wrappers to keep footer at bottom */
...
const MainContent = styled.div`
  ...
  /* This extra top padding plus container margin helps push the form lower */
  padding-top: 2rem;
`;
...
const SignupContainer = styled.div`
  ...
  min-width: 600px;
  max-width: 900px;
  /* Increased top margin so the form sits lower on the page */
  margin: 6rem auto 0;
  padding: 4rem;
  background-color: #ffffff;
  border-radius: 8px;
            ...
            <Form>
              {toggle === "Volunteer" ? (
                ...
                <>
                  ...
                  <TextArea
                    placeholder="Brief Description of Organization/Initiative"
                    required
                  />
                </>
              )}
