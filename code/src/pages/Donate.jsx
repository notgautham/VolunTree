...
import ImageCarousel from "../components/ImageCarousel"; // Remove if not used
...
/* Define 41 animated circles (reuse from your Initiatives design) */
...
/* Card Grid for analytics and event cards */
      ...
      <DonateContainer>
        ...
        <AnimatedSection ref={heroRef} visible={heroVisible} isHero>
          <SectionBox>
            ...
            <SectionSubtitle>
              Your contributions help fund volunteering programs and provide essential resources to those in need.
            </SectionSubtitle>
          </SectionBox>
        </AnimatedSection>
        
        {/* DONATION ANALYTICS SECTION */}
        <AnimatedSection ref={analyticsRef} visible={analyticsVisible}>
          <SectionBox>
            <SectionTitle>Donation Analytics</SectionTitle>
            <CardGrid>
              <Card>
              ...
              <Card>
                <h3><Highlight>₹1,200,000</Highlight></h3>
                <p>Total Donated</p>
              </Card>
              <Card>
                <h3><Highlight>John Doe</Highlight></h3>
                <p>Largest Individual Donor</p>
              </Card>
              <Card>
                <h3><Highlight>50+</Highlight></h3>
        ...
        <AnimatedSection ref={formRef} visible={formVisible}>
          <SectionBox>
            ...
            <SectionSubtitle>
              Fill in the form below to contribute. Every donation, big or small, makes a difference.
            </SectionSubtitle>
            <FormContainer>
              <Form>
                <FormGroup>
                ...
                <FormGroup>
                  ...
                  <Input id="amount" type="number" placeholder="e.g., 500" required />
                </FormGroup>
                <FormGroup>
                  <Label htmlFor="message">Message</Label>
                  <TextArea id="message" placeholder="Your Message (Optional)" />
                </FormGroup>
